 ...
 */
const MARKS: Record<string, string> = { openai, anthropic, gemini, deepseek, 'deepseek-anthropic': deepseek, qwen, openrouter, ollama, lmstudio };
